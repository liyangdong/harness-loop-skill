...
Active task board for java-sdd-example. Updated each loop iteration.

## Current epic

(fill in current epic)
...
- Check off (`[x]`) only after `scripts/check-consistency.sh` passes for that subtask.
